...
"@action-sheet-item-background": "@bg",
...
"@button-default-background-color": "@bg",
...
"@button-plain-background-color": "@bg",
...
// CellGroup
"@cell-group-background-color": "@bg",
...
"@collapse-item-content-background-color": "@bg",
...
"@dropdown-menu-background-color": "@bg",
...
"@grid-item-content-background-color": "@bg",
"@grid-item-content-active-color": "@active-color",
"@grid-item-icon-size": "28px",
"@grid-item-text-color": "@gray-darker",
"@grid-item-text-font-size": "@font-size-sm",
// GoodsAction
"@goods-action-background-color": "@bg",
...
"@index-anchor-sticky-background-color": "@bg",
// IndexBar
...
// ImagePreview
"@image-preview-index-text-color": "@bg",
...
// NumberKeyboard
"@number-keyboard-background-color": "@bg",
...
"@number-keyboard-button-text-color": "@bg",
...
"@pagination-background-color": "@bg",
...
"@password-input-background-color": "@bg",
...
"@sidebar-selected-background-color": "@bg",
// Skeleton
...
"@slider-button-background-color": "@bg",
...
"@stepper-background-color": "@bg",
"@stepper-button-icon-color": "@text-color",
"@stepper-button-disabled-color": "#bg",
"@stepper-button-disabled-icon-color": "@gray",
"@stepper-input-width": "32px",
"@stepper-input-height": "28px",
"@stepper-input-font-size": "@font-size-md",
"@stepper-input-text-color": "@text-color",
"@stepper-input-disabled-text-color": "@text-color",
"@stepper-input-disabled-background-color": "@bg",
"@stepper-border-radius": "50px",
// SubmitBar
"@submit-bar-height": "50px",
"@submit-bar-z-index": "100",
"@submit-bar-background-color": "@bg",
...
"@uploader-upload-background-color": "@bg",
"@uploader-delete-color": "@bg",
